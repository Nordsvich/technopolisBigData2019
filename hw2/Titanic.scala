...
private val TRAIN_PATH: String = "../scala/src/main/scala/train.csv"
private val TEST_PATH: String = "../scala/src/main/scala/test.csv"
  ...
  def main(args: Array[String]): Unit = {
    ...
    val (dataDFRaw, predictDFRaw) = loadData(TRAIN_PATH, TEST_PATH, spark)
    ...
    predictions
      ...
      .format("csv")
      .option("header", "true")
      .save("../scala/src/main/scala/output")
  }
